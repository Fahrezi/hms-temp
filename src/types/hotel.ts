...
export type GuestStatus = 'checked-in' | 'checked-out' | 'reserved';
export type GuestHotelStatus = 'in-house' | 'arriving-today' | 'arriving-soon' | 'reserved' | 'departing-today' | 'departed' | 'no-reservation';
